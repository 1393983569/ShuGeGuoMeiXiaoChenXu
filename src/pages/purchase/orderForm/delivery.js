...
export default class Index extends Component {
  ...
  // 获取数据
  getList() {
    queryNoPageOrder(2, Taro.getStorageSync('adminId').shopId, Taro.getStorageSync('orderItem'), Taro.getStorageSync('orderName')).then(res => {
              ...
              <View className='didNotOpen' key={index + 'f'}>
                ...
                <View className='didNotOpen-button'>
                  <View className='didNotOpen-button-box'>
                    <Button size='mini' disabled className='didNotOpen-button-b'>已派单</Button>
                  </View>
                </View>
              </View>
            )
